...
| `blog.html` | Sección pensada para publicaciones de ideas, proyectos, actividades y avances personales. |
...
- Generar ideas para la mejora de diseño.
- Proponer estructuras HTML y CSS.
- Revisar y corregir fragmentos de código.
- Mejorar textos y descripciones.
